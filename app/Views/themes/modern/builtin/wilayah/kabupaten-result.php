<div class="card">
	<div class="card-header">
		<h5 class="card-title"><?=$current_module['judul_module']?> - Kabupaten/Kota</h5>
	</div>
	<div class="card-body">
	<?php
	if (!empty($msg)) {
	...
	<div class="table-responsive">
		...
		$column = [
			...
			'id_wilayah_kabupaten' => 'ID',
			'nama_kabupaten' => 'Nama Kabupaten/Kota',
		...
		<span id="dataTables-url" style="display:none"><?=base_url('builtin/wilayah/getDataKabupatenDT')?></span>
