<div class="card">
	<div class="card-header">
		<h5 class="card-title"><?=$current_module['judul_module']?> - Kecamatan</h5>
	</div>
	<div class="card-body">
	<?php
	if (!empty($msg)) {
	...
	<div class="table-responsive">
		...
		<span id="dataTables-url" style="display:none"><?=base_url('builtin/wilayah/getDataKecamatanDT')?></span>
